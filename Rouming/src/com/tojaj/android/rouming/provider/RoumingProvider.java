	...
	public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (match) {
	    	case METADATA:
	    		...
	    		break;
        	case PICTURES_ID:
        		builder.appendWhere(RoumingContract.Pictures._ID + "=" + uri.getLastPathSegment());
        	case PICTURES:
			...
			case PICTURES:			
		        ...
		        try { 
		            ...
		            for (ContentValues value : values){
		                insert.bindLong(1, value.getAsLong(RoumingContract.Pictures.TIME));
		                insert.bindString(2, value.getAsString(RoumingContract.Pictures.NAME));
		                insert.bindString(3, value.getAsString(RoumingContract.Pictures.DETAIL_URL));
		                insert.bindString(4, value.getAsString(RoumingContract.Pictures.PICTURE_URL));
		                insert.bindLong(5, value.getAsLong(RoumingContract.Pictures.SIZE));
		                insert.bindLong(6, value.getAsLong(RoumingContract.Pictures.LIKES));
		                insert.bindLong(7, value.getAsLong(RoumingContract.Pictures.DISLIKES));
		                insert.bindLong(8, value.getAsLong(RoumingContract.Pictures.COMMENTS));
