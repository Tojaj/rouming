...
public class MainActivity extends FragmentActivity implements
	...
	private class DrawerMenuItem  {
		...
		public DrawerMenuItem(String name, Class<?> fragmentClass, String fragmentId) {
			this.mName = name;
		...
		public Fragment getInstance() {
			...
			try {
				instance = (Fragment) mFragmentClass
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mDrawerMenuItems.add(new DrawerMenuItem(
						getString(R.string.fragment_pictures),
	...
	public void OnPictureClicked(String local_uri, String origin_uri, String name) {
		if (local_uri != null) {
			...
			Toast.makeText(this, R.string.no_image_available, Toast.LENGTH_SHORT).show();
		}
	}
}
